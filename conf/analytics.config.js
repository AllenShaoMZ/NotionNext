...
module.exports = {
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-NW8N7WC0QJ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-fFiPtSIfGO', // Remove the value or replace it with your own google site verification code
